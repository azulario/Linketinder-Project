...
// Dados iniciais (SEED)
    private seed(): void {
        ...
        const empresa1 = new Empresa(
            ...
            "Tech Solutions",
            "12.345.678/0001-10",
            "contato@techsolution.com",
            "https://placehold.co/400x400/3498db/ffffff?text=TS"
        );
        const empresa2 = new Empresa(
            ...
            "98.765.432/0001-55",
            "rh@inovacorp.com",
            "https://placehold.co/400x400/2ecc71/ffffff?text=IT"
        );
        ...
        const candidato1 = new Candidato(
            ...
            "https://placehold.co/400x400/e74c3c/ffffff?text=AS",
        ...
        const candidato2 = new Candidato(
            ...
            "https://placehold.co/400x400/f1c40f/ffffff?text=BS",
            ['Python', 'R', 'SQL']
        );
        const candidato3 = new Candidato(
            ...
            "987.654.321-00",
            "carla.p@email.com",
            "https://placehold.co/400x400/9b59b6/ffffff?text=CP",
        ...
        const candidato4 = new Candidato(
            ...
            "123.456.789-09",
            "d.c@email.com",
            "https://placehold.co/400x400/1abc9c/ffffff?text=DC",
            ['Segurança da Informação', 'Redes', 'Criptografia']
        );
